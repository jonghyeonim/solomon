...
<div class="footer-container">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 col-sm-12 footer-text text-center">
                가푸게임즈 사업자번호: 514-27-08380 대표이사: 최병건 <br>
                대구광역시 동구 동대구로467 고객센터: gapugames@gmail.com <br>
                <div>COPYRIGHTS GAPUGAMES Creative Lab.<br> ALL RIGHTS RESERVED.</div>
            </div>
        </div>
    </div>
</div>
