<input type="hidden" id="checkMobile" value="<?php echo $this->config->item('is_mobile');?>">
</div>
<div class="footer-container">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 col-sm-12 footer-text">
                가푸게임즈 사업자번호: 514-27-08380 대표이사: 최병건 <br>
                대구광역시 동구 동대구로 467 고객센터: gapu.games@gmail.com <br>
                Copyright GAPUGAMES Creative Lab. All Rights Reserved.
            </div>
        </div>
    </div>
</div>
