            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <form class="form-horizontal" enctype="multipart/form-data"
                        ...
                        <input type="hidden" name="itemid" id="itemid" value="<?php echo $item->_recruitid;?>">
                        <input type="hidden" name="dirkeycode" id="dirkeycode" value="recruit">
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?= site_url('/recruit/index') ?>" class="btn btn-default pull-right"
