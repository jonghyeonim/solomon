                    ...
                    <div class="col-xs-12">
                        ...
                        if ($item->isdeprecated) {
                            ...
                            <a class="btn btn-danger pull-right"
                               href="<?= site_url('recruit/change_isdeprecated?recruitid=' . $item->_recruitid) . '&isdeprecated=false' ?>">
                            ...
                            <a class="btn btn-success pull-right"
                               href="<?= site_url('recruit/change_isdeprecated?recruitid=' . $item->_recruitid) . '&isdeprecated=true' ?>">
                        ...
                        <a class="btn btn-warning pull-right" style="margin-right: 5px;"
                           href="<?= site_url('recruit/update?recruitid=' . $item->_recruitid) ?>">
                            <i class="fa fa-file-excel-o"></i>수정하기
                        </a>
                        <a class="btn btn-primary pull-right" style="margin-right: 5px;"
                           href="<?= site_url('recruit/index') ?>">
